...
export class AvaDashboardWidget extends ReactWidget {
  ...
  protected render(): React.ReactNode {
    return React.createElement(AvaDashboardApp, {
      ...
      onArchiveMemory: (scope: 'global' | 'project', id: string) => this.service.archiveMemory(scope, id),
      onRestoreMemory: (scope: 'global' | 'project', id: string) => this.service.restoreMemory(scope, id),
      onDeleteMemory: (scope: 'global' | 'project', id: string) => this.service.deleteMemoryEntry(scope, id),
      onGetCurrentVersion: () => this.service.getCurrentVersion(),
