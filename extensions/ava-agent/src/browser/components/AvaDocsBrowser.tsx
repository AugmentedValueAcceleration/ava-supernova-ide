  ...
  return (
    <div style={s.container}>
      ...
      <div style={s.content}>
        ...
        {activeTab === 'tools' && (
          <div style={s.section}>
            <div style={s.sectionTitle}>Built-in Tools (45)</div>
...
const MODES = [
  { name: 'Code Mode', desc: 'Full agent with all 45 tools. Reads, writes, searches, and executes across your codebase.' },
